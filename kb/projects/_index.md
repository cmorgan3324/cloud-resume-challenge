...
Terraform-managed AWS infrastructure providing secure remote access via WireGuard VPN with integrated DNS-based ad-blocking.

**Key Achievements:**

- **~$9-12/month** operational cost with free-tier eligible t2.micro instance
- **SSM Session Manager** eliminates SSH key management and bastion hosts
- **WireGuard** protocol for modern, fast VPN with lower latency than OpenVPN
- Complete Infrastructure as Code with Terraform managing 10 AWS resources

**Tech Stack:** AWS (EC2, VPC, IAM, Systems Manager, EBS), Terraform, WireGuard, Amazon Linux 2023
